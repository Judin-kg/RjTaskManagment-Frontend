...
const StaffSignup = (isOpen) => {
  ...
  useEffect(() => {
    if (isOpen) {
      axios
        .get("https://rj-task-managment-rjatlas-server.vercel.app/api/assistant-managers")
  ...
  const handleSubmit = async (e) => {
    ...
    setMessage('');
    try {
      const res = await axios.post('https://rj-task-managment-rjatlas-server.vercel.app/api/auth/signup', formData);
